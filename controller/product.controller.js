...
export const SaveProduct = async (req, res) => {
  try {
    ...
    req.body.Purchase_Rate = Number(req.body.Purchase_Rate || 0);
    req.body.GSTRate = Number(req.body.GSTRate || 0);
    req.body.ProfitPercentage = Number(req.body.ProfitPercentage || 0);
    req.body.Opening_Stock = Number(req.body.Opening_Stock || 0);
    ...
    if (profitPercentage === 0) {
      ...
      if (purchaseRate > 0) {
        ...
        req.body.SalesRate = 0;
        req.body.Product_MRP = 0;
          ...
          if (document.id) {
            ...
            if (existingId) {
              ...
              if (
                ...
                document[SalesRate] =
                  (document.Purchase_Rate * (document.ProfitPercentage + 100)) /
                  100;
                document[Product_MRP] =
                  document.SalesRate *
                  (1 + document.GSTRate / 100) *
...
export const addProductInWarehouse3 = async (
  warehouse,
  warehouseId,
  orderItem,
  date
